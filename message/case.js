...
var ownerNumber = [`${nomerOwner}@s.whatsapp.net`,`6281316643491@s.whatsapp.net`,`${alice.user.jid}`]
...
if (args[0].startsWith(`+${6281316643491}`)) return reply('Tidak bisa call ke nomor ini!')
